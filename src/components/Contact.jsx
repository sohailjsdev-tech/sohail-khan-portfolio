...
const Contact = () => {
  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'sohailjsdev@gmail.com',
      link: 'mailto:sohailjsdev@gmail.com',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/sohailjsdev-tech',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/sohail-khan-06bb0b329/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {submitStatus === 'success' && (
              <div className="mt-4 p-4 bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-300 rounded-lg">
